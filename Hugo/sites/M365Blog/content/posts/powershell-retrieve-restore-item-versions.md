---
title: "Powershell Retrieve Restore Previous Versions"
...
Start-Transcript
    ...
    # Tenant URL
    $siteUrl = Read-Host -Prompt "Enter site collection URL " #"https://ppfonline.sharepoint.com/teams/app-ar"
 
    Connect-PnPOnline -Url $siteUrl -Interactive
    $PaymentsList = "Payments"
 
    ListVersions-ARData -List $PaymentsList -Key "202401" "System Account" "2024-07-01"  
